...
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_gradana.png')
time.sleep(2)

driver.get('http://www.danamapan.id/')
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_danamapan.png')
time.sleep(2)
...
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_danalaut.png')
time.sleep(2)
...
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_pinjamduit.png')
time.sleep(2)
...
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_geteasycash.png')
time.sleep(2)
...
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_pinduit.png')
time.sleep(2)

driver.get('http://smartcapital.id/')
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_smartcapital.png')
time.sleep(2)
...
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_plazapinjaman.png')
time.sleep(2)
...
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_danafix.png')
time.sleep(2)
...
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_lenteradana.png')
time.sleep(2)
...
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_empatkali.png')
time.sleep(2)

driver.get('http://www.jembatanemas.id/')
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_jembatanemas.png')
time.sleep(2)
...
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_klikkami.png')
time.sleep(2)

driver.get('http://www.kaching.id/')
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_kaching.png')
time.sleep(2)

driver.get('http://www.finplus.co.id/')
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_finplus.png')
time.sleep(2)
...
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_syarfi.png')
time.sleep(2)
...
screenshot = driver.save_screenshot('FolderPNG/noinfo_asakita.png')
time.sleep(2)
...
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_bocil.png')
time.sleep(2)
...
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_onehope.png')
time.sleep(2)

driver.get('http://www.ladangmodal.com/')
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_ladangmodal.png')
time.sleep(2)
...
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_restock.png')
time.sleep(2)

driver.get('http://www.solusi-ku.id/')
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_solusi-ku.png')
time.sleep(2)
...
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_adapundi.png')
time.sleep(2)
...
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_edufund.png')
time.sleep(2)
...
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_tunasaku.png')
time.sleep(2)

driver.get('http://www.uatas.id/')
time.sleep(5)
screenshot = driver.save_screenshot('FolderPNG/noinfo_uatas.png')
time.sleep(2)

targetPath_PNG = os.path.join(cwd, datestring)
